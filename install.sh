...
npm i  -D webpack babel-loader babel-core babel-preset-es2015 babel-plugin-transform-es2015-modules-commonjs
npm i  -D angular angular-ui-router bootstrap html style-loader css-loader